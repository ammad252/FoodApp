...
public class DetailActivity1 extends AppCompatActivity {
    ...
    Button btnUpdate, btnDelete,order, s_order;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(DetailActivity1.this,dropdown.class);
                startActivity(i);
        ...
        s_order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                recipeItemPrice = recipePrice.getText().toString();
                SharedPreferences sharedPreferences = getSharedPreferences("MyPrefs", Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("savedText", recipeItemPrice);
                editor.apply();
...
//                        FoodData1 foodData = documentSnapshot.toObject(FoodData1.class);
...
//            });
    ...
    public void btnDeleteRecipe(View view) {
        ...
        DocumentReference documentReference = firebaseFirestore.collection("users").document(userID).collection("Recipes").document();
        documentReference.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        startActivity(new Intent(getApplicationContext(),Admin_Daskboard.class));
                        finish();
                    }
    ...
    public void btnUpdateRecipe(View view) {
        ...
        startActivity(new Intent(getApplicationContext(), UpdateRecipeActivity1.class)
    ...
    public void btnDislike(final View view) {
        ...
        FoodData1 fireStoreFoodData = new FoodData1(recipeItemName,recipeDescription,recipeItemPrice,imageUrl,key,favoriteKey);
