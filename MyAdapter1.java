...
public class MyAdapter1 extends RecyclerView.Adapter<FoodViewHolder1>{

    private Context mContext;
    private List<FoodData1> myFoodList;
    ...
    public MyAdapter1(Context mContext, List<FoodData1> myFoodList) {
    ...
    public FoodViewHolder1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext)
                .inflate(R.layout.recycler_row_item1, parent, false);
        return new FoodViewHolder1(itemView);
    }

    @NonNull
    @Override
    public void onBindViewHolder(@NonNull final FoodViewHolder1 holder, int position) {
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final Intent intent = new Intent(mContext, DetailActivity1.class);
    ...
    public void filteredList(ArrayList<FoodData1> filterList) {
