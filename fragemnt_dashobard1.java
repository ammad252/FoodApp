...
public class fragemnt_dashobard1 extends AppCompatActivity {
    FirebaseAuth firebaseAuth;
    FirebaseUser firebaseUser;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fragemnt_dashobard1);
...
//        }
    ...
    public void btn_uploadActivity(View view) {
        startActivity(new Intent(this, Upload_Recipe1.class));
    }
    ...
    public void onBackPressed() {
           Intent i =new Intent(getApplicationContext(),Admin_Daskboard.class);
           startActivity(i);
    }
